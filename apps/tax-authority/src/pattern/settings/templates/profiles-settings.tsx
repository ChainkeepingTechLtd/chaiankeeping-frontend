						...
						<form onSubmit={handleSubmit(onSubmit)}>
							<div className='grid grid-cols-2 gap-4 my-5 '>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className='w-full grid gap-2'>
											<FormLabel htmlFor='firstName'>Tax Authority</FormLabel>
											<FormControl>
												<Input
													id='firstName'
													placeholder='SIRS'
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className='w-full grid gap-2'>
											<FormLabel htmlFor='firstName'>Personnel Name</FormLabel>
											<FormControl>
												<Input
													id='firstName'
													placeholder='Convexity'
													type='text'
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className='w-full grid gap-2'>
											<FormLabel htmlFor='firstName'>Personnel ID</FormLabel>
											<FormControl>
												<Input
													id='firstName'
													placeholder='111-111'
							...
							<div className='grid xl:grid-cols-2 items-end justify-end w-full'>
								<FormField
									name='nin'
									render={({ field }) => (
										<FormItem className='w-full grid gap-2'>
