...
import TeamTable from "../organisms/team-table";
import { BranchData, TeamData } from "../molecules/team-data";
import BranchTable from "../organisms/branch-table";
...
const BranchTemplate = () => {
	...
	return (
		<div className='h-full'>
			{hasAccount ? (
				<div className='md:pr-8 flex h-full gap-4 justify-between pt-10 max-sm:px-4 max-sm:flex-col'>
					<div className='flex-col flex gap-4 w-full'>
						<BranchTable data={BranchData as any} />
					</div>
				</div>
			) : (
