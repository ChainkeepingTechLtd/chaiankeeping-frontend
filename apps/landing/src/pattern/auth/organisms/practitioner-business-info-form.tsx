...
import { businessCategory, businessInfoSchema, licenseNumberInfoSchema, PractitionerSignupFormData } from "@/pattern/schema/auth-schema"
...
export const PractitionerBusinessInfoForm = ({ onSubmit, onBack, defaultValues, step, totalSteps }: BusinessInfoFormProps) => {
    const form = useForm({
        resolver: zodResolver(businessInfoSchema.merge(licenseNumberInfoSchema)),
        defaultValues: {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full grid gap-2">
                                    ...
                                    <FormControl>
                                        <Input placeholder="8893489498" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
