			...
			case "Taxes Due":
				return (
					<div className=' gap-4 w-full items-start mt-4'>
						<p className='font-sen font-bold mb-6 max-sm:px-4 text-[#202B3C]'>
							Taxes - Due
						</p>
						<TaxesDueTable />
					</div>
	...
	return (
		<div className='h-full w-full flex flex-col'>
			...
			<div className='fixed left-0 w-full bg-white shadow-md z-10 pt-3 max-sm:pt-16 whitespace-nowrap'>
				<div className='flex justify-between md:px-8 mx-auto px-4 max-sm:text-sm'>
					<div className='flex'>
						<button
			...
			{/* Tab Content */}
			<div className='pt-24 md:px-8 w-full max-sm:pt-32'>{renderContent()}</div>
		</div>
	);
};
